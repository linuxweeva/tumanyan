...
<div class="">
    ...
    <form class="form" method="POST" action="{{ route( 'books.store' ) }}">
        ...
        <div class="form-group">
            ...
            <select class="form-control select2" data-autocomplete="{{ route( 'autocomplete.authors' ) }}" name="author_id" required="">
        ...
        <div class="form-group">
            ...
            <select class="form-control select2" data-autocomplete="{{ route( 'autocomplete.sections' ) }}" name="section_id" required="">
        ...
        <div class="form-group">
            ...
            <select data-autocomplete="{{ route( 'autocomplete.languages' ) }}" class="form-control select2" name="language_id" required="">
